...
class TuringMachine:
    ...
    def transition_function(self, state, char):
        ...
        if state == 'q0':
            ...
            if char == '0': return 'q_shift_only', 'X', 'L' 
            if char == '1': return 'q_add_and_shift', 'X', 'L' 
            if char == 'X': return 'q2', 'X', 'L' 
            if char == '*': return 'q_accept', '*', 'R' 
